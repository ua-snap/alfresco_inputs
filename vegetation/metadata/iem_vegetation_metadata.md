...
(https://github.com/EarthScientist/alfresco_inputs/blob/dc5c48c1c744b45f637f0faa685ec9e79aa3a9df/vegetation/landcarbon_vegetation_maritime.py)

  
**4 Mainland Alaska** - all remaining ecoregions excluding the Aleutian Islands  
(https://github.com/EarthScientist/alfresco_inputs/blob/dc5c48c1c744b45f637f0faa685ec9e79aa3a9df/vegetation/alfresco_vegetation.py)

*Note, legend values in these code bases do not represent final values in legend above*

All inputs were processed in their native resolution, and only resampled to 1km in the final step where the 4 regions were mosaiced together.
...
**NLCD Classes | NLCD descriptions | Final IEM land cover class value - name**  
...
41 | deciduous | 12 - Maritime Alder Scrubland  
...
**NLCD Classes | NLCD descriptions | Intermediate IEM land cover class value - name**  
0,11,12,21,22,23,24,31 | ?,open water, perennial snow/ice, developed open space, developed low, developed med,developed high, barren | 0 - Not Modeled
...
if originally 41, 43, 51, 52, 71, 72, 90, 95 and now 10 or 11 and canopy cover >20%, then = 10 - Maritime Forest Wetland  
...
if the pixels falls within the harvested masked area, then = 9 - Maritime Upland Forest
...
**coastal interior** - this layer was derived through combining features of the Nowacki Ecoregions in Alaska (Nowacki, Gregory; Spencer, Page; Fleming, Michael; Brock, Terry; and Jorgenson, Torre. Ecoregions of Alaska: 2001.), and the Ecozones and Ecoregions of Canada (A National Ecological Framework for Canada: Attribute Data. Marshall, I.B., Schut, P.H., and Ballard, M. 1999. Agriculture and Agri-Food Canada, Research Branch, Centre for Land and Biological Resources Research, and Environment Canada, State of the Environment Directorate, Ecozone Analysis Branch, Ottawa/Hull.).
