...
if __name__ == '__main__':
	...
	output_dir = '/workspace/Shared/Tech_Projects/ALFRESCO_Inputs/project_data/Vegetation/Output_Data_2010'
	styles_dir = '/workspace/Shared/Tech_Projects/ALFRESCO_Inputs/project_data/Vegetation/Input_Data/qgis_styles'
	
	output_veg = os.path.join( output_dir, 'alfresco_model_vegetation_input_2010_v0_1.tif' )
	meta_updater = dict( driver='GTiff', dtype=rasterio.uint8, compress='lzw', crs={'init':'epsg:3338'}, count=1, nodata=255 )

	input_paths = {
		'lc05':os.path.join( input_dir, 'NA_LandCover_2010_25haMMU_akcan_masked.tif' ),
	...
	lc_mod = replace_erroneous_treeline( lc_mod, treeline ) #lc_mod.filled()
