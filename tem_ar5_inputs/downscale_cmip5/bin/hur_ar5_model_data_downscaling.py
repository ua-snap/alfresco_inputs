...
def shiftgrid(lon0,datain,lonsin,start=True,cyclic=360.0):
	...
	NOTE: this has been stolen from the basemap python package since the package
	is sometimes problematic to properly install and this function does not 
	require the remainder of the package to run properly.
