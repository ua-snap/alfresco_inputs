...
for(j in 1:nlayers(crustack.desiredCells.e)){
	...
	writeRaster(nc.interp.r, filename=paste("/big_storage/malindgren/AIEM/RHUM/hur_cru_10min_1961_1990/cru_10min_splined_extent/",crustack@layernames[j],".tif",sep=""), overwrite=T)
