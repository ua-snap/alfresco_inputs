...
if __name__ == '__main__':
	...
	expanded_ext_fn = os.path.join( base_path, 'intermediate', variable + '_cru_ts20_1961_1990_climatology_3338_akcan_expanded.shp' )
	...
	akcan_path = os.path.join( base_path, 'cru_ts20', 'akcan', variable )
