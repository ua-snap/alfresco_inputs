	...
	if files:
		...
		for fn in files:
			...
			if 'historical' in fn:
				...
				if 'tas_' in fn:
					os.system( 'python hur_ar5_model_data_downscaling.py' + ' -hi ' + os.path.join( root, fn ) + ' -o ' + output_dir + ' -bt ' + '1901-01' + \
									' -et ' + '2005-12' + ' -cbt ' + '1961-01' + ' -cet ' + '1990-12' + \
									' -cru ' + cru_path + ' -at ' + anomalies_calc_type )
				elif 'hur_' in fn:
					# run with only the historical file
					os.system( 'python hur_ar5_model_data_downscaling.py' + ' -hi ' + os.path.join( root, fn ) + ' -o ' + output_dir + ' -bt ' + '1901-01' + \
									' -et ' + '2005-12' + ' -cbt ' + '1961-01' + ' -cet ' + '1990-12' + \
									' -plev ' + plev + ' -cru ' + cru_path + ' -at ' + anomalies_calc_type )
				else:
					NotImplementedError( "only 'hur' & 'tas' have been implemented here" )
			else:
				...
				if 'tas_' in fn:
					...
					os.system( 'python hur_ar5_model_data_downscaling.py' + ' -mi ' + os.path.join( root, fn ) + ' -hi ' + historical_fn + ' -o ' + output_dir + \
									' -bt ' + '2006-01' + ' -et ' + '2100-12' + ' -cbt ' + '1961-01' + ' -cet ' + '1990-12' + ' -plev ' + plev + \
									' -cru ' + cru_path + ' -at ' + anomalies_calc_type )
				else:
					NotImplementedError( "only 'hur' & 'tas' have been implemented here" )
